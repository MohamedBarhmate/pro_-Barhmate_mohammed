...
<?php foreach ($leProduit as $produit): ?>
    ...
    <div class="mb-3">
        ...
        <input type="name" class="form-control" name="name" value="<?= $produit->name ?>" required>

    </div>
    <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label">Quantity</label>
        <input type="text" class="form-control" name="quantity" value="<?= $produit->quantity ?>"  required>
    </div>

    <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label">Price</label>
        <input type="number" class="form-control" name="price" value="<?= $produit->price ?>" required>
    </div>

    <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label">img_url</label>
        <textarea class="form-control" name="img_url" required><?= $produit->img_url ?></textarea>
    </div>
    <div class="mb-3">
